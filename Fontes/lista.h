...
/***********************************************************************
*
*  $FC Função: LIS  &Inserir elemento ordenado
*
*  $ED Descrição da função
*     Insere novo elemento de uma forma ordenada.
...
*                 Pode ser NULL
*        pComp  - ponteiro para a função de comparação que determinara
...
/***********************************************************************
*
*  $FC Função: LIS  &Excluir valor elemento corrente
*
*  $ED Descrição da função
*     Exclui o valor do elemento corrente da lista dada.
*
*  $EP Parâmetros
*     pLista    - ponteiro para a lista na qual deve excluir.
*
...
/***********************************************************************
*
*  $FC Função: LIS  &Alterar valor corrente
*
*  $ED Descrição da função
*     Altera o valor do elemento corrente da lista.
*     Faz nada se a lista está vazia.
*
*  $EP Parâmetros
*     pLista - ponteiro para a lista a manipular
*     pDado  - dado a ser posto no elemento
*
***********************************************************************/
